...
<head>
    ...
    <title>{{ config('app.name', 'Lensa Jember') }} - @yield('title')</title>
        ...
        <nav class="container mx-auto px-4">
            ...
            <div class="md:hidden hidden fade-in" id="mobile-menu">
                <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                    <a href="{{ route('home') }}"
                       class="block px-3 py-2 rounded-md text-base font-medium text-gray-600 hover:text-blue-600 hover:bg-gray-50 transition-all duration-200">
                        Home
                    </a>
                    <a href="{{ route('destinations.index') }}"
                       class="block px-3 py-2 rounded-md text-base font-medium text-gray-600 hover:text-blue-600 hover:bg-gray-50 transition-all duration-200">
                    ...
                    <a href="{{ route('destinations.create') }}"
                       class="block px-3 py-2 rounded-md text-base font-medium text-white bg-gradient-to-r from-blue-600 to-teal-500 hover:from-teal-500 hover:to-blue-600 transition-all duration-200">
                        Add Destination
                    </a>
                </div>
            </div>
        ...
        <div class="container mx-auto px-4 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="col-span-1 md:col-span-2">
                    <h3 class="text-xl font-bold mb-4 bg-gradient-to-r from-blue-400 to-teal-400 bg-clip-text text-transparent">About Lensa Jember</h3>
                    <p class="text-gray-400 mb-4">Discover the hidden gems and beautiful destinations of Jember through our comprehensive tourism catalog. Experience the culture, nature, and attractions that make Jember unique.</p>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="{{ route('destinations.index') }}" class="text-gray-400 hover:text-white transition-colors duration-200">Destinations</a></li>
                        <li><a href="{{ route('categories.index') }}" class="text-gray-400 hover:text-white transition-colors duration-200">Categories</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        ...
                        <li class="flex items-center space-x-2">
                            ...
                            <span>Jl. Kalimantan No.37, Jember</span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="border-t border-gray-700 mt-12 pt-8 text-center text-gray-400">
                <p>&copy; {{ date('Y') }} Lensa Jember. All rights reserved.</p>
            </div>
        </div>
    </footer>
