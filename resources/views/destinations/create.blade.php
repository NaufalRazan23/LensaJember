...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        <a href="{{ route('destinations.index') }}" class="text-blue-600 hover:text-blue-800">&larr; Back to Destinations</a>
    </div>

    <div class="card">
        <div class="p-8">
            <h1 class="text-3xl font-bold text-gray-800 mb-6">Add New Destination</h1>
            ...
            <form action="{{ route('destinations.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="entry_fee" id="entry_fee" value="{{ old('entry_fee') }}"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        @error('entry_fee')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
