...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex items-center mb-8">
        ...
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Tambah Wisata Baru</h1>
            <p class="text-gray-600 mt-2">Lengkapi informasi wisata yang akan ditambahkan</p>
        </div>
    </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" id="name" name="name" required
                                   ...
                                   placeholder="Masukkan nama wisata" value="{{ old('name') }}">
                            @error('name')
                        ...
                        <div>
                            ...
                            <input type="number" id="entry_fee" name="entry_fee" min="0"
                                   ...
                                   placeholder="0 (kosongkan jika gratis)" value="{{ old('entry_fee') }}">
                            @error('entry_fee')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="mt-6">
                        ...
                        <textarea id="description" name="description" rows="4" required
                                  ...
                                  placeholder="Deskripsikan wisata ini...">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea id="address" name="address" rows="3" required
                                      ...
                                      placeholder="Masukkan alamat lengkap wisata">{{ old('address') }}</textarea>
                            @error('address')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" id="latitude" name="latitude" step="any" required
                                       ...
                                       placeholder="-8.1234567" value="{{ old('latitude') }}">
                                @error('latitude')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" id="longitude" name="longitude" step="any" required
                                       ...
                                       placeholder="113.1234567" value="{{ old('longitude') }}">
                                @error('longitude')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="text-sm text-gray-500">
                            <p>💡 Tip: Gunakan Google Maps untuk mendapatkan koordinat yang akurat</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="opening_hours" name="opening_hours"
                                   ...
                                   placeholder="08:00 - 17:00" value="{{ old('opening_hours') }}">
                            @error('opening_hours')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="contact_number" name="contact_number"
                                   ...
                                   placeholder="0812-3456-7890" value="{{ old('contact_number') }}">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div>
                        ...
                        @error('featured_image')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-sm text-gray-500">Format: JPG, PNG, GIF. Maksimal 2MB. Resolusi recommended: 1200x800px.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    <div class="space-y-3">
                        ...
                        <a href="{{ route('admin.wisata.index') }}" class="w-full btn-secondary block text-center">
                            Batal
                        </a>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (!featuredImage) {
            if (!confirm('Anda belum mengupload gambar utama. Lanjutkan tanpa gambar?')) {
                e.preventDefault();
                return false;
            }
        }
