...
<head>
    ...
    <title>Login - Explore Jember</title>
    ...
    <div class="max-w-md w-full space-y-8 px-4">
        ...
        <div class="text-center fade-in">
            <div class="flex items-center justify-center space-x-3 mb-8">
                ...
                <div>
                    ...
                    <p class="text-blue-100 text-sm">Katalog Wisata Kabupaten Jember</p>
                </div>
            </div>
            ...
            <p class="text-blue-100 mb-8">
                Masuk untuk menjelajahi destinasi wisata Jember
            </p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8 fade-in hover-scale">
            <form action="{{ route('login') }}" method="POST" class="space-y-6">
                ...
                <!-- Login Button -->
                <button type="submit"
                        class="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 px-4 rounded-lg font-medium hover:from-blue-700 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-300 hover-scale">
